...
namespace Diploma_Project.DatabaseDataSetTableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[3].CommandText = "UPDATE `Orders` SET `NameOfUser` = ?, `Completed` = ? WHERE `ID` = ?";
        ...
        public virtual int FillBy(DatabaseDataSet.OrdersDataTable dataTable, string NameOfUser) {
        ...
        public virtual int UpdateOrder(string NameOfUser, global::System.Nullable<bool> Completed, int Original_ID) {
            ...
            if ((Completed.HasValue == true)) {
                command.Parameters[1].Value = ((bool)(Completed.Value));
            }
            else {
    ...
    public partial class PurchasesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT * FROM Purchases WHERE UserID = ?";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
