...
namespace Diploma_Project.DatabaseDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Products` WHERE ((`ID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `ProductType` IS NULL) OR (`ProductType` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `ImagePath` IS NULL) OR (`ImagePath` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Products` (`ProductName`, `ProductType`, `Description`, `Price`, `Im" +
                "agePath`) VALUES (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Products` SET `ProductName` = ?, `ProductType` = ?, `Description` = ?, `Price` = ?, `ImagePath` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `ProductType` IS NULL) OR (`ProductType` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `ImagePath` IS NULL) OR (`ImagePath` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, ProductName, ProductType, Description, Price, ImagePath FROM Products";
        ...
        public virtual int Delete(int Original_ID, string Original_ProductName, string Original_ProductType, global::System.Nullable<decimal> Original_Price, string Original_ImagePath) {
        ...
        public virtual int Update(string ProductName, string ProductType, string Description, global::System.Nullable<decimal> Price, string ImagePath, int Original_ID, string Original_ProductName, string Original_ProductType, global::System.Nullable<decimal> Original_Price, string Original_ImagePath) {
            if ((ProductName == null)) {
